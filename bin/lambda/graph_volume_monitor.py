    ...
    response = ssm.send_command(
      ...
      Parameters={
        "commands": [
          ...
          "    ",
          "    # Get the device",
          "    DEVICE=$(df $DATA_MOUNT | tail -1 | awk '{print $1}')",
          '    echo "Device detected: $DEVICE"',
          "    ",
          "    # Get current and available size",
          "    CURRENT_SIZE=$(df -BG $DATA_MOUNT | tail -1 | awk '{print $2}' | sed 's/G//')",
          ...
          "    if sudo xfs_growfs $DATA_MOUNT 2>/dev/null; then",
