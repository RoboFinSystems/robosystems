...
def reset_sec_database(confirm: bool = False, backend: str = "ladybug") -> Dict:
  ...
  async def reset_database():
    ...
    try:
      ...
      # Create repository metadata using SharedRepositoryService
      # This handles Graph record, GraphSchema, and DuckDB staging tables
      ...
      # Get DuckDB table count from repo_result
      duckdb_tables_created = len(
        repo_result.get("database_info", {}).get("tables", [])
      )
