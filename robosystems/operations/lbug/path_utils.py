...
using the LadybugDB single-file format with .lbug extension.
"""
...
def get_lbug_database_path(db_name: str, base_path: Optional[str] = None) -> Path:
  ...
  Args:
      ...
      base_path: Optional base path override (defaults to LBUG_DATABASE_PATH env var)

  Returns:
      Path object for the database file (.lbug extension)
  """
