...
Adapter assets — including per-repository publish assets — live inside their
adapter packages (e.g., adapters/sec/pipeline/s3_publish.py) and are collected
via get_dagster_components() in definitions.py.
"""
