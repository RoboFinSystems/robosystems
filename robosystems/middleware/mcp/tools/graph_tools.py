  ...
  def get_tool_definition(self) -> dict[str, Any]:
    return {
      ...
      "description": (
        ...
        "- subgraph_type: `static` (default) or `knowledge` (auto-includes the "
        "knowledge schema)\n\n"
  ...
  def get_tool_definition(self) -> dict[str, Any]:
    return {
      ...
      "description": (
        ...
        "- rebuild: Drop existing data and rebuild from scratch (staged).\n"
        "  An extensions graph that already exists is always rebuilt\n"
        "  alongside and swapped in, regardless of this flag.\n"
