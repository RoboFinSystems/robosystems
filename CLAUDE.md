...
- **Root `/`** serves the Swagger UI (HTML) **in development only**; don't use it for health checks. In staging and production `/` and `/docs` answer `301` to `robosystems.ai/docs/api`, where the reference is rendered per operation.
