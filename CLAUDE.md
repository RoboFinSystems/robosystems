...
│   │   ├── views/                # Graph reads (LadybugDB XBRL hypercube; information_blocks.py = xbrlkit over the report's slice)
...
BILLING_ENABLED=false      # code default; local dev runs billing-off
