#!/usr/bin/env python3
"""
Element Mapping Demo - Main Orchestration Script

This script runs the complete element mapping demo workflow:
...
6. Create subgraph workspace with element mappings (CoA → US-GAAP)
7. Test view generation with mappings
8. Save views as materialized reports
...
def main():
  ...
  print("\n" + "=" * 70)
  print("📊 Element Mapping Demo - Complete Workflow")
  print("=" * 70)
  ...
  run_script("06_create_subgraph.py")

  run_script("07_test_views.py")

  run_script("08_save_view_as_report.py")

  print("\n" + "=" * 70)
  print("✅ Element Mapping Demo - Complete!")
  print("=" * 70)
  print("\n💡 What you learned:")
  print("   ✓ Element mapping structures (CoA → US-GAAP)")
  print("   ✓ Aggregation methods (SUM, AVERAGE, WEIGHTED_AVERAGE, etc.)")
  print("   ✓ View generation with/without mappings")
  print("   ✓ Saving views as materialized reports")
  print("   ✓ Real-world use case: Granular → Standardized reporting")
  print("\n💡 Next steps:")
  print("   - Recreate subgraph: uv run 06_create_subgraph.py")
  print("   - Compare views: uv run 07_test_views.py")
  print("   - Save reports: uv run 08_save_view_as_report.py")
