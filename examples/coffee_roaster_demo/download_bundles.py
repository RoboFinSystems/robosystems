...
JSONLD_PATH = OUTPUT_DIR / "coffee-roaster-demo.jsonld"
XBRL_PATH = OUTPUT_DIR / "coffee-roaster-demo.zip"

GRAPH_SLOT = "coffee_roaster_demo"
DEMO_RECIPE = "just demo-coffee-roaster"
...
def download_bundles_for_report(
  ...
  shacl_md = out_dir / "coffee-roaster-demo-shacl-validation.md"
  xbrl_md = out_dir / "coffee-roaster-demo-xbrl-validation.md"
  conforms = validate_shacl(out_dir / JSONLD_PATH.name, shacl_md, "Driftline Coffee")
  valid = validate_arelle(out_dir / XBRL_PATH.name, xbrl_md, "Driftline Coffee")
  ...
  databook_md = out_dir / "coffee-roaster-demo.databook.md"
  write_databook(
    out_dir / JSONLD_PATH.name,
    databook_md,
    "Driftline Coffee Roasters Demo",
    shacl_md=shacl_md,
    xbrl_md=xbrl_md,
  )
