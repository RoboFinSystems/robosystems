...
ACCOUNTS = [
  ...
  # Revenue
  ("4000", "Consulting Revenue", "inflow", "operating_revenue", "credit", None),
  ("4100", "Strategy Advisory Revenue", "inflow", "operating_revenue", "credit", None),
  (
    "4200",
  ...
  # Expenses
  ("5000", "Salaries & Wages", "outflow", "operating_expense", "debit", None),
  ("5100", "Payroll Taxes", "outflow", "operating_expense", "debit", None),
  ("5200", "Health Insurance", "outflow", "operating_expense", "debit", None),
  ("6000", "Office Rent", "outflow", "operating_expense", "debit", None),
  ("6100", "Software Subscriptions", "outflow", "operating_expense", "debit", None),
  ("6200", "Cloud Hosting", "outflow", "operating_expense", "debit", None),
  ("6300", "Professional Development", "outflow", "operating_expense", "debit", None),
  ("6400", "Business Insurance", "outflow", "operating_expense", "debit", None),
  ("6500", "Office Supplies", "outflow", "operating_expense", "debit", None),
  ("6600", "Travel & Entertainment", "outflow", "operating_expense", "debit", None),
  ("7000", "Depreciation Expense", "outflow", "operating_expense", "debit", None),
]
