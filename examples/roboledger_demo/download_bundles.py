...
demo emits: the Tavi compiled model (``.tavi.json``, stamped at publish), the
native holon (``.holon.jsonld``), the XBRL 2.1 zip and its Arelle verdict. All
flavors are pulled from the report endpoint via the published SDK.
