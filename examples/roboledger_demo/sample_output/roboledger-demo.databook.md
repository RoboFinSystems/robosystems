---
id: https://robosystems.ai/report/rpt_01KVF94CFWZ98EPA84K7V2EY45
type: DataBook
...
provenance:
  ...
  method: "Materialized RoboSystems Report rpt_01KVF94CFWZ98EPA84K7V2EY45 (generation 1, draft)"
manifest:
  entrypoints:
    - block: balance_sheet
...
- **FactSet**: `fs_01KVF94CHNRJ4E25PMT7ZM6Y70`

| QName | Concept | 2024-01-02 → 2025-12-31 |
|---|---|---:|
| `rs-gaap:CashAndCashEquivalentsAtCarryingValue` |     Cash and Cash Equivalents, at Carrying Value | $63,695.00 |
...
| `rs-gaap:PropertyPlantAndEquipmentNet` |     Property, Plant and Equipment, Net | $4,925.03 |
...
- **FactSet**: `fs_01KVF94CHNRJ4E25PMT7ZM6Y71`

| QName | Concept | 2024-01-02 → 2025-12-31 |
|---|---|---:|
| `rs-gaap:RevenueFromContractWithCustomerExcludingAssessedTax` |     Revenue from Contract with Customer, Excluding Assessed Tax | $153,500.00 |
| `rs-gaap:Revenues` |   **Revenues** | $153,500.00 |
| `rs-gaap:GrossProfit` |   **Gross Profit** | $153,500.00 |
| `rs-gaap:GeneralAndAdministrativeExpense` |     General and Administrative Expense | $132,005.00 |
| `rs-gaap:DepreciationDepletionAndAmortization` |     Depreciation, Depletion and Amortization | $1,374.97 |
| `rs-gaap:OperatingExpenses` |   **Operating Expenses** | $133,379.97 |
| `rs-gaap:OperatingIncomeLoss` |   **Operating Income (Loss)** | $20,120.03 |
...
- **FactSet**: `fs_01KVF94CHP3SYVSAPNGWCPM7QM`
...
| `rs-gaap:NetCashProvidedByUsedInOperatingActivities` |   Cash Provided by (Used in) Operating Activity, Including Discontinued Operation | $18,695.00 |
...
- **FactSet**: `fs_01KVF94CHP3SYVSAPNGWCPM7QN`
