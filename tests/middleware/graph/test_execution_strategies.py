...
class TestEstimateResultSize:
    ...
    def test_count_no_limit(self):
        assert BaseAnalyzer._estimate_result_size("RETURN COUNT( something", None) == "small"
