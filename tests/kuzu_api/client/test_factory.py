...
from robosystems.kuzu_api.client.factory import (
  KuzuClientFactory,
  CircuitBreaker,
  get_kuzu_client,
...
class TestKuzuClientFactory:
  ...
  def mock_env(self):
    ...
    with patch("robosystems.kuzu_api.client.factory.env") as mock:
  ...
  async def test_create_client_for_user_graph(self, mock_env):
    ...
    with patch(
      "robosystems.kuzu_api.client.factory.KuzuAllocationManager"
      ...
      with patch("robosystems.kuzu_api.client.factory.KuzuClient") as MockClient:
  ...
  async def test_create_client_for_subgraph(self, mock_env):
    ...
    with patch(
      ...
      with patch("robosystems.kuzu_api.client.factory.httpx.AsyncClient"):
...
class TestFactoryFunctions:
  ...
  async def test_get_kuzu_client_for_sec_ingestion(self):
    ...
    with patch("robosystems.kuzu_api.client.factory.env") as mock_env:
