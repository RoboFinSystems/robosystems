...
from robosystems.kuzu_api.core.cluster_manager import (
  KuzuClusterService,
  validate_cypher_query,
)
from robosystems.kuzu_api.core.utils import (
  validate_database_name,
  validate_query_parameters,
)
from robosystems.kuzu_api.app import create_app
from robosystems.kuzu_api.models.database import QueryRequest, DatabaseCreateRequest
...
class TestKuzuClusterService:
  ...
  @patch("robosystems.kuzu_api.core.cluster_manager.KuzuDatabaseManager")
  @patch("robosystems.kuzu_api.core.cluster_manager.ThreadPoolExecutor")
  ...
  @patch("robosystems.kuzu_api.core.cluster_manager.psutil")
  @patch("robosystems.kuzu_api.core.cluster_manager.KuzuDatabaseManager")
...
class TestFastAPIEndpoints:
  ...
  def setup_method(self):
    ...
    from robosystems.kuzu_api.core import cluster_manager
  ...
  def test_execute_query_endpoint(self):
    ...
    from robosystems.kuzu_api.models.database import QueryResponse
  ...
  def test_list_databases_endpoint(self):
    ...
    from robosystems.kuzu_api.models.database import DatabaseListResponse, DatabaseInfo
  ...
  def test_create_database_endpoint_entity_writer(self):
    ...
    from robosystems.kuzu_api.models.database import DatabaseCreateResponse
  ...
  def test_database_health_endpoint(self):
    ...
    from robosystems.kuzu_api.models.database import DatabaseInfo
  ...
  def test_ingest_data_endpoint_read_only(self):
    ...
    with patch(
      "robosystems.kuzu_api.core.connection_pool._connection_pool", MagicMock()
    ):
      app = create_app()
      client = TestClient(app)
