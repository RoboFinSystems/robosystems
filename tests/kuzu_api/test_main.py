"""Tests for kuzu_api main module."""
...
class TestMain:
  ...
  @patch("robosystems.kuzu_api.main.uvicorn.run")
  @patch("robosystems.kuzu_api.main.create_app")
  @patch("robosystems.kuzu_api.main.init_cluster_service")
