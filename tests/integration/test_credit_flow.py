...
from robosystems.operations.graph.credit_service import CreditService, get_operation_cost
...
class TestCreditServiceFlow:
    ...
    def test_consume_credits_real_operation(self, test_db, test_graph_with_credits):
        ...
        initial_balance = float(credits.current_balance)
    ...
    def test_can_create_graph_tier_validation(self, test_db):
        ...
        assert service._can_create_graph_tier("ladybug-standard", GraphTier.LADYBUG_STANDARD) is True
        assert service._can_create_graph_tier("ladybug-standard", GraphTier.LADYBUG_LARGE) is False
        # Large can create standard and large
        assert service._can_create_graph_tier("ladybug-large", GraphTier.LADYBUG_LARGE) is True
        # XLarge can create all
        assert service._can_create_graph_tier("ladybug-xlarge", GraphTier.LADYBUG_XLARGE) is True
