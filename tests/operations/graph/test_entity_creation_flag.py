...
class TestEntityCreationFlag:
    ...
    async def test_create_entity_true_creates_entity_node(
        ...
        with patch.object(
            entity_service, "_generate_graph_id", return_value="kg_test_123"
        ):
            with patch(
                ...
                with patch(
                    ...
                    mock_mgr_instance.allocate_database = AsyncMock(
                    ...
                    with patch(
                        ...
                        mock_kuzu_client.get_database = AsyncMock(
                        ...
                        with patch(
                            ...
                            with patch(
                                "robosystems.models.iam.graph_schema.GraphSchema.create"
                            ):
                                with patch(
    ...
    async def test_create_entity_false_skips_entity_node(
        ...
        with patch.object(
            entity_service, "_generate_graph_id", return_value="kg_test_456"
        ):
            with patch(
                "robosystems.models.iam.user_limits.UserLimits.get_or_create_for_user"
            ) as mock_user_limits:
    ...
    async def test_create_entity_defaults_to_true_when_not_specified(
        ...
        with patch.object(
            entity_service, "_generate_graph_id", return_value="kg_test_789"
        ):
            with patch(
                "robosystems.models.iam.user_limits.UserLimits.get_or_create_for_user"
            ) as mock_user_limits:
