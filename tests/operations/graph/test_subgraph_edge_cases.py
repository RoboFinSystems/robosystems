...
class TestSubgraphEdgeCases:
  ...
  def test_multiple_underscores_in_graph_id(self):
    """Test handling of graph IDs with multiple underscores"""
    graph_id_with_multiple_underscores = "kg123_dev_test"

    parent_id, subgraph_name = parse_graph_id(graph_id_with_multiple_underscores)
    assert parent_id == "kg123"
    assert subgraph_name == "dev_test"
  ...
  def test_valid_subgraph_id_patterns(self):
    ...
    valid_subgraph_ids = [
      ...
      ("kg123_staging", "kg123", "staging"),
      ("kg1_test", "kg1", "test"),
      ("kg123_a", "kg123", "a"),
      ("kg123_12345", "kg123", "12345"),
      ("kg123_A1B2C3", "kg123", "A1B2C3"),
    ]
  ...
  def test_maximum_length_subgraph_name(self):
    ...
    subgraph_id = f"kg123_{max_length_name}"

    constructed = construct_subgraph_id("kg123", max_length_name)
