...
class TestStorageBillingConfig:
  ...
  def test_storage_included_constants(self):
    ...
    assert StorageBillingConfig.STORAGE_INCLUDED["ladybug-standard"] == 100
    assert StorageBillingConfig.STORAGE_INCLUDED["ladybug-large"] == 500
    assert StorageBillingConfig.STORAGE_INCLUDED["ladybug-xlarge"] == 2000

  def test_overage_costs_constants(self):
    """Test OVERAGE_COSTS constants."""
    assert StorageBillingConfig.OVERAGE_COSTS["ladybug-standard"] == Decimal("1.00")
    assert StorageBillingConfig.OVERAGE_COSTS["ladybug-large"] == Decimal("0.50")
    assert StorageBillingConfig.OVERAGE_COSTS["ladybug-xlarge"] == Decimal("0.25")
...
class TestCalculateStorageOverage:
  ...
  def test_no_overage_standard_tier(self):
    """Test no overage for ladybug-standard tier within limits."""
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("50"), tier="ladybug-standard"
    )
  ...
  def test_no_overage_exactly_at_limit(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("100"), tier="ladybug-standard"
    )
  ...
  def test_overage_standard_tier(self):
    """Test overage calculation for ladybug-standard tier."""
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("150"), tier="ladybug-standard"
    )
  ...
  def test_overage_enterprise_tier(self):
    """Test overage calculation for ladybug-large tier."""
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("600"), tier="ladybug-large"
    )
  ...
  def test_overage_premium_tier(self):
    """Test overage calculation for ladybug-xlarge tier."""
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("2100"), tier="ladybug-xlarge"
    )
  ...
  def test_overage_with_cold_storage(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("150"), tier="ladybug-standard", storage_type="cold"
    )
  ...
  def test_overage_with_hot_storage(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("150"), tier="ladybug-standard", storage_type="hot"
    )
  ...
  def test_overage_unknown_storage_type(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("150"), tier="ladybug-standard", storage_type="unknown_type"
    )
  ...
  def test_fractional_storage_amounts(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("150.75"), tier="ladybug-standard"
    )
  ...
  def test_zero_storage(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("0"), tier="ladybug-standard"
    )
...
class TestGetStorageLimits:
  ...
  def test_storage_limits_standard_tier(self):
    """Test storage limits for ladybug-standard tier."""
    result = StorageBillingConfig.get_storage_limits("ladybug-standard")
  ...
  def test_storage_limits_enterprise_tier(self):
    """Test storage limits for ladybug-large tier."""
    result = StorageBillingConfig.get_storage_limits("ladybug-large")
  ...
  def test_storage_limits_premium_tier(self):
    """Test storage limits for ladybug-xlarge tier."""
    result = StorageBillingConfig.get_storage_limits("ladybug-xlarge")
...
class TestEdgeCases:
  ...
  def test_very_small_decimal_amounts(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("100.001"), tier="ladybug-standard"
    )
  ...
  def test_precision_preservation(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("123.456"), tier="ladybug-large", storage_type="cold"
    )
  ...
  def test_complex_calculation_precision(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("523.789"), tier="ladybug-large", storage_type="cold"
    )
  ...
  def test_string_tier_handling(self):
    ...
    result_upper = StorageBillingConfig.calculate_storage_overage(
      ...
      tier="LADYBUG-STANDARD",  # Uppercase - should default to unknown tier
    )
  ...
  def test_none_values_handling(self):
    ...
    with pytest.raises((TypeError, AttributeError)):
      StorageBillingConfig.calculate_storage_overage(
        storage_gb=None, tier="ladybug-standard"
      )
  ...
  def test_negative_storage_amounts(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("-10"), tier="ladybug-standard"
    )
...
class TestCostCalculationAccuracy:
  ...
  def test_cent_precision(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal("501"),  # 1 GB overage above ladybug-large limit (500 GB)
      tier="ladybug-large",
  ...
  def test_sub_cent_calculations(self):
    ...
    result = StorageBillingConfig.calculate_storage_overage(
      storage_gb=Decimal(
        "2000.1"
      ),  # 0.1 GB overage above ladybug-xlarge limit (2000 GB)
      tier="ladybug-xlarge",
      storage_type="cold",
    )
