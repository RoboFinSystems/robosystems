...
class TestQBClient:
  ...
  def test_initialization_success(
    ...
    with patch("robosystems.adapters.qb.env") as mock_env:
  ...
  def test_initialization_mock_token_skip_refresh(
    ...
    with patch("robosystems.adapters.qb.QuickBooks"):
      # Execute
      QBClient(realm_id, credentials)
  ...
  def test_initialization_no_access_token(
    ...
    with patch("robosystems.adapters.qb.env"):
      # Execute
  ...
  @patch("robosystems.adapters.qb.QBClient.get_accounts")
