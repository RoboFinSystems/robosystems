...
class TestSECClient:
  ...
  @patch("robosystems.adapters.sec.requests.get")
  ...
  @patch("robosystems.adapters.sec.SECClient.get_companies")
  ...
  @patch("robosystems.adapters.sec.SECClient.get_submissions")
  ...
  @patch("robosystems.adapters.sec.SECClient.download_xbrlzip")
  @patch("robosystems.adapters.sec.SECClient.get_xbrlzip_url")
