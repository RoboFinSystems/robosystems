...
class TestArelleClient:
  ...
  @patch("robosystems.adapters.arelle.Cntlr.Cntlr")
  @patch("robosystems.adapters.arelle.ArelleClient._setup_cache_directory")
  @patch("robosystems.adapters.arelle.ArelleClient._initialize_controller")
  ...
  @patch("robosystems.adapters.arelle.ArelleClient._register_sec_transformations")
  @patch("robosystems.adapters.arelle.ArelleClient._configure_webcache")
  @patch("robosystems.adapters.arelle.ArelleClient._load_plugins")
  @patch("robosystems.adapters.arelle.Cntlr.Cntlr")
  @patch("robosystems.adapters.arelle.ArelleClient._setup_cache_directory")
  ...
  @patch("robosystems.adapters.arelle.ArelleClient._populate_cache_from_bundle")
  @patch("robosystems.adapters.arelle.env")
  @patch("robosystems.adapters.arelle.Path.mkdir")
  def test_setup_cache_directory_with_env_var(
    ...
    with patch("robosystems.adapters.arelle.env", mock_env):
  ...
  @patch("robosystems.adapters.arelle.env")
  @patch("robosystems.adapters.arelle.os.access")
  def test_setup_cache_directory_mounted_volume(self, mock_access, mock_env, temp_dir):
    ...
    with patch("robosystems.adapters.arelle.Path") as mock_path_class:
      ...
      with patch("robosystems.adapters.arelle.__file__", str(temp_dir / "arelle.py")):
  ...
  @patch("robosystems.adapters.arelle.shutil.copy2")
  @patch("robosystems.adapters.arelle.Path.glob")
  ...
  @patch("robosystems.adapters.arelle.WebCache")
  ...
  def test_cache_directory_environment_setup(self, temp_dir):
    ...
    with patch("robosystems.adapters.arelle.env") as mock_env:
      mock_env.ARELLE_CACHE_DIR = None
